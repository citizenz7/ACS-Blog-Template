<?php
/*
Plugin Name: Blogmail-ACS-0720
Plugin URI: https://github.com/citizenz7/ACS-Blog-Template
Description: Ce plugin permet d'envoyer un mail à une liste d'adresses à chaque fois qu'un article est publié.
Version: 0.1
Author: citizenz7
